...
const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "launch.microphoneGain": "Mic Gain",
    "launch.microphoneGainHint": "Boost voice level before writing track (with clipping protection).",
  ...
  "zh-CN": {
    ...
    "launch.microphoneGain": "麦克风增益",
    "launch.microphoneGainHint": "录制时先提升人声音量（含防爆音保护）。",
